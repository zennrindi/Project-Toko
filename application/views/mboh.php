...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('assets/'); ?>#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('assets/'); ?>buttons.html">Buttons</a>
            <a class="collapse-item" href="<?php echo base_url('assets/'); ?>cards.html">Cards</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('assets/'); ?>#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('assets/'); ?>#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('assets/'); ?>login.html">Login</a>
            <a class="collapse-item" href="<?php echo base_url('assets/'); ?>register.html">Register</a>
            <a class="collapse-item" href="<?php echo base_url('assets/'); ?>forgot-password.html">Forgot Password</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Other Pages:</h6>
            <a class="collapse-item" href="<?php echo base_url('assets/'); ?>404.html">404 Page</a>
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item text-center small text-gray-500" href="<?php echo base_url('assets/'); ?>#">Show All Alerts</a>
              </div>
            </li>
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('assets/'); ?>#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo base_url('assets/'); ?>https://source.unsplash.com/fn_BT9fwg_E/60x60" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('assets/'); ?>#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo base_url('assets/'); ?>https://source.unsplash.com/AU4VPcFN4LE/60x60" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('assets/'); ?>#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo base_url('assets/'); ?>https://source.unsplash.com/CS2uCrpNzJY/60x60" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('assets/'); ?>#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo base_url('assets/'); ?>https://source.unsplash.com/Mv9hjnEUHR4/60x60" alt="">
                    <div class="status-indicator bg-success"></div>
                  </div>
                  <div>
                ...
                <a class="dropdown-item text-center small text-gray-500" href="<?php echo base_url('assets/'); ?>#">Read More Messages</a>
              </div>
            </li>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo base_url('assets/'); ?>#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
          </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="<?php echo base_url('assets/'); ?>#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p>Add some quality, svg illustrations to your project courtesy of <a target="_blank" rel="nofollow" href="<?php echo base_url('assets/'); ?>https://undraw.co/">unDraw</a>, a constantly updated collection of beautiful svg images that you can use completely free and without attribution!</p>
                  <a target="_blank" rel="nofollow" href="<?php echo base_url('assets/'); ?>https://undraw.co/">Browse Illustrations on unDraw &rarr;</a>
                </div>
              </div>
